...
class BankTransfer(Payment):
    ...
    def charge(self, accountDetails, hasFailed=False):
        ...
        accountDetails.update(
            {"payment_type": "banktransfer", "is_bank_transfer": True, "country": "NG"}
        )
