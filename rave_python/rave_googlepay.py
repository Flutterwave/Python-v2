...
class GooglePay(Payment):
    ...
    def charge(self, requestDetails, hasFailed=False):
        ...
        requiredParameters = ["amount", "email", "firstname", "lastname", "currency"]

        return super(GooglePay, self).charge(
    ...
    #     return super(GooglePay, self).verify(txRef, endpoint)

    # def refund(self, flwRef, amount):
    #     endpoint = self._baseUrl + self._endpointMap["account"]["refund"]
    #     return super(GooglePay, self).refund(flwRef, amount)
