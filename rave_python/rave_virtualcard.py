...
# from rave_python.rave_exceptions import CardCreationError, CardStatusError, ServerError
...
#         response = requests.post(
#             endpoint, headers=self.headers, data=json.dumps(vcardDetails)
#         )
...
#         endpoint = (
#             self._baseUrl
#             + self._endpointMap["virtual_card"]["list"]
#             + "?seckey="
#             + self._getSecretKey()
#         )
#         data = {"seckey": self._getSecretKey()}
#         return self._handleCardStatusRequests(
#             "List", endpoint, isPostRequest=True, data=data
#         )
...
#         endpoint = (
#             self._baseUrl
#             + self._endpointMap["virtual_card"]["terminate"]
#             + str(card_id)
#             + "/terminate"
#         )
#         data = {"seckey": self._getSecretKey()}
...
#         data = {"seckey": self._getSecretKey()}
#         return self._handleCardStatusRequests(
#             "Get", endpoint, isPostRequest=True, data=data
#         )
...
#         endpoint = (
#             self._baseUrl
#             + self._endpointMap["virtual_card"]["freeze"]
#             + str(card_id)
#             + "/status/block"
#         )
#         data = {"seckey": self._getSecretKey()}
#         return self._handleCardStatusRequests(
#             "Freeze", endpoint, isPostRequest=True, data=data
#         )
...
#         endpoint = (
#             self._baseUrl
#             + self._endpointMap["virtual_card"]["unfreeze"]
#             + str(card_id)
#             + "/status/unblock"
#         )
#         data = {"seckey": self._getSecretKey()}
#         return self._handleCardStatusRequests(
#             "Unfreeze", endpoint, isPostRequest=True, data=data
#         )
...
#         return self._handleCardStatusRequests(
#             "Fund", endpoint, isPostRequest=True, data=data
#         )
