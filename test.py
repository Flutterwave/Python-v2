...
class TestRavePaymentOptions(unittest.TestCase):
    def setUp(self):
        ...
        self.bulk_transferDetails = {"title": "May Staff Salary",
                                     "bulk_data": [{"Bank": "044",
        ...
        self.bills_payment_details_2 = {"service": "fly_buy_bulk",
                                        "service_method": "post",
                                        "service_version": "v1",
                                        "service_channel": "rave",
                                        "service_payload": {"BatchReference": "batch-rave-150928302799933928",
    ...
    #     # This test case checks that on initiating a payment, the user is
    #     # requested to validate the payment
    ...
    #     # This test case checks that a user validates a transaction
    #     # appropriately
    #     self.assertEqual(
    #         self.rave.Account.validate(
    #             res["flwRef"],
    #             "12345")["error"],
    #         False)
    #     with self.assertRaises(TransactionValidationError):
    #         # a wrong otp to ensure TransactionValidationError is raised
    #         # anytime a wrong otp is passed
    #         self.rave.Account.validate(res["flwRef"], "123")

    #     self.assertEqual(
    #         self.rave.Account.verify(
    #             res["txRef"])["transactionComplete"], True)
    #     with self.assertRaises(TransactionVerificationError):
    #         # a wrong txRef to ensure TransactionVerificationError is raised
    #         # anytime a wrong transaction reference is passed
    #         self.rave.Account.verify("MC-8883838388881")
    ...
    #         # anytime a wrong otp is passed
    #         self.rave.Card.validate(
    #             "FLW-MOCK-5a039c016e64da9b226c2562dcd76756", "12345")
    ...
    #         # a wrong txRef to ensure TransactionVerificationError is raised
    #         # anytime a wrong transaction reference is passed
    #         self.rave.Card.verify("MC-8883838388881")
    ...
    #     with self.assertRaises(IncompletePaymentDetailsError):
    #         self.rave.Card.charge(
    #             self.faulty_saved_card_details,
    #             chargeWithToken=True)

    #     self.assertEqual(
    #         self.rave.Card.verify(
    #             res["txRef"])["transactionComplete"],
    #         True)
    #     with self.assertRaises(TransactionVerificationError):
    #         # a wrong txRef to ensure TransactionVerificationError is raised
    #         # anytime a wrong transaction reference is passed
    ...
    #     with self.assertRaises(IncompletePaymentDetailsError):
    #         self.rave.SubAccount.createSubaccount(
    #             self.faulty_subaccountDetails_1)
    ...
    #     # fetch
    #     res = self.rave.SubAccount.fetchSubaccount(
    #         'RS_BF94DDF6AA2AB40BE874EA32DBD4DAA1')
    #     self.assertIsNotNone(res["error"])
    #     self.assertIsNotNone(res["returnedData"]["status"])
    #     self.assertEqual(res["returnedData"]["status"], "success")
    #     self.assertEqual(res["error"], False)
    ...
    #     res = self.rave.Francophone.charge(
    #         self.francophone_mobile_charge_details)
    #     self.assertIsNotNone(res["error"])
    #     self.assertEqual(res["error"], False)
    #     with self.assertRaises(IncompletePaymentDetailsError):
    #         self.rave.Francophone.charge(
    #             self.faulty_francophone_mobile_charge_details)
