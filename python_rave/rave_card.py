...
class Card(Payment):
    ...
    def _handleVerifyResponse(self, response, txRef):
        ...
        # if the chargecode is not 00
            ...
            return {"status": status, "error": False, "transactionComplete": False, "amount": amount, "chargedAmount": chargedAmount, "chargecode": chargeCode, "vbvmessage": vbvmessage, "txRef": txRef, "flwRef": flwRef, "cardToken": responseJson["data"]["card"]["card_tokens"][0]["embedtoken"]}
        
        else:
            return {"status": status, "error": False, "transactionComplete": True, "amount": amount, "chargedAmount": chargedAmount, "chargecode": chargeCode, "vbvmessage": vbvmessage, "txRef": txRef, "flwRef": flwRef, "cardToken": responseJson["data"]["card"]["card_tokens"][0]["embedtoken"]}
